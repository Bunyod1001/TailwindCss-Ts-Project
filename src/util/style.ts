export const styles = {
    ...
    heading1:"font-montserrat font-semibold xs:text-[72px] text-[52px] text-white ss:leading[100px] leading-[75px] w-full",
...
export const layout = {
    ...
    sectionImageRevarse:`flex-1 flex ${styles.flexCenter} md:mr-10 mr-0 md:mt-10 mt-10 relative`,
};